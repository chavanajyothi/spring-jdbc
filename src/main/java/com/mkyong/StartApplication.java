...
public class StartApplication implements CommandLineRunner {
    ...
    @Autowired
    private com.mkyong.repository.CustomerRepository crepo;
    ...
    void startCustomer() {
        ...
        List<com.mkyong.Customer> customers = Arrays.asList(
        			new com.mkyong.Customer(new Long(1),"Narasimha",10),
        			new com.mkyong.Customer(new Long(2),"Jyothi",20)
        		);
        
        log.info("[SAVE]");
        customers.forEach(customer -> {
            log.info("Saving...{}", customer.getName());
            crepo.save(customer);
        });
        
        log.info("[COUNT] Total books: {}", crepo.count());
